...
export class ChangeUIDColumnTypes1605023081783 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            "ALTER TABLE `gm` ADD `game_id` binary(16) NOT NULL"
        );
        await queryRunner.query("ALTER TABLE `gm` DROP PRIMARY KEY");
        await queryRunner.query(
            "ALTER TABLE `gm` ADD PRIMARY KEY (`user_id`, `game_id`)"
        );
        await queryRunner.query("ALTER TABLE `gm` DROP PRIMARY KEY");
        await queryRunner.query("ALTER TABLE `gm` ADD PRIMARY KEY (`game_id`)");
        await queryRunner.query("ALTER TABLE `gm` DROP COLUMN `user_id`");
        await queryRunner.query(
            "ALTER TABLE `gm` ADD `user_id` binary(16) NOT NULL"
        );
        await queryRunner.query("ALTER TABLE `gm` DROP PRIMARY KEY");
        await queryRunner.query(
            "ALTER TABLE `gm` ADD PRIMARY KEY (`game_id`, `user_id`)"
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            "ALTER TABLE `player` ADD PRIMARY KEY (`user_id`)"
        );
        await queryRunner.query("ALTER TABLE `player` DROP COLUMN `game_id`");
        await queryRunner.query(
            "ALTER TABLE `player` ADD `game_id` binary(16) NOT NULL"
        );
        await queryRunner.query("ALTER TABLE `player` DROP PRIMARY KEY");
        await queryRunner.query(
            "ALTER TABLE `player` ADD PRIMARY KEY (`user_id`, `game_id`)"
        );
        await queryRunner.query("ALTER TABLE `player` DROP PRIMARY KEY");
        await queryRunner.query(
        ...
        await queryRunner.query(
            "ALTER TABLE `player` ADD `user_id` binary(16) NOT NULL"
        );
        await queryRunner.query("ALTER TABLE `player` DROP PRIMARY KEY");
        await queryRunner.query(
            "ALTER TABLE `player` ADD PRIMARY KEY (`game_id`, `user_id`)"
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `player` DROP COLUMN `user_id`");
        await queryRunner.query(
            "ALTER TABLE `player` ADD `user_id` binary(1) NOT NULL"
        );
        await queryRunner.query("ALTER TABLE `player` DROP PRIMARY KEY");
        await queryRunner.query(
            "ALTER TABLE `player` ADD PRIMARY KEY (`user_id`, `game_id`)"
        ...
        await queryRunner.query("ALTER TABLE `player` DROP COLUMN `game_id`");
        await queryRunner.query(
            "ALTER TABLE `player` ADD `game_id` binary(1) NOT NULL"
        );
        await queryRunner.query("ALTER TABLE `player` DROP PRIMARY KEY");
        await queryRunner.query(
            "ALTER TABLE `player` ADD PRIMARY KEY (`game_id`, `user_id`)"
        ...
        await queryRunner.query("ALTER TABLE `gm` DROP COLUMN `user_id`");
        await queryRunner.query(
            "ALTER TABLE `gm` ADD `user_id` binary(1) NOT NULL"
        );
        await queryRunner.query("ALTER TABLE `gm` DROP PRIMARY KEY");
        await queryRunner.query(
            "ALTER TABLE `gm` ADD PRIMARY KEY (`user_id`, `game_id`)"
        ...
        await queryRunner.query("ALTER TABLE `gm` DROP COLUMN `game_id`");
        await queryRunner.query(
            "ALTER TABLE `gm` ADD `game_id` binary(1) NOT NULL"
        );
        await queryRunner.query("ALTER TABLE `gm` DROP PRIMARY KEY");
        await queryRunner.query(
            "ALTER TABLE `gm` ADD PRIMARY KEY (`game_id`, `user_id`)"
